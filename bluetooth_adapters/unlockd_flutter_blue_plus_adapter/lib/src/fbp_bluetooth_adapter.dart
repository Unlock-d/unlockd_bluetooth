...
import 'package:unlockd_flutter_blue_plus_adapter/src/extension/fbp_bluetooth_connector.dart';
...
class FbpBluetoothAdapter extends UnlockdBluetoothAdapter {
  FbpBluetoothAdapter._() {
    assert(
      () {
  ...
  /// Returns the [FbpBluetoothAdapter] instance.
  static final FbpBluetoothAdapter instance = FbpBluetoothAdapter._();
